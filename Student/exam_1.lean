...
| (alpha_to_beta, beta_to_gamma) => fun (a : α) => beta_to_gamma (alpha_to_beta a)
...
-- Your answer here
structure Sandwich : Type := (bread : Bread) (topping : Sum Cheese Spread)
...
| _, [] => []
| alpha_to_beta, h::t => (alpha_to_beta h) :: (map alpha_to_beta t)
